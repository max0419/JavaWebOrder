...
public class EmailService {
	...
	public static void main(String [] args) {
		new EmailService().sendEmail("a22492122@gmail.com", "http://localhost:8080/JavaWebCart/");
	}
	
	// Google應用程式密碼
	// 請參考此篇 https://www.yongxin-design.com/Article/10
	// 請自行產生Google應用程式密碼
	String googleAppPassword = "jxde gjmz qlxc dtbj";

	// 寄件者的電子郵件地址
	String from = "a22492122@gmail.com";
